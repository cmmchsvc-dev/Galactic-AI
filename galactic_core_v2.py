...
class GalacticCore:
    ...
    def load_config(self):
        ...
        if not os.path.exists(config_full_path):
            config = {
                'system': {'name': 'Galactic AI', 'version': '1.4.7', 'port': 9999},
        ...
        defaults = {
            ...
            'social_media': {
                ...
                'reddit':  {'client_id': '', 'client_secret': '', 'username': '', 'password': '', 'user_agent': 'GalacticAI/1.4.7'},
            },
        ...
        sys_defaults = {'update_check_interval': 21600, 'version': '1.4.7'}
